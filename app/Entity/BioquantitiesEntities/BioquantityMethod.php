...
class ExperimentVariable implements IdentifiedObject
{
	...
	/**
	 * @ORM\ManyToOne(targetEntity="Bioquantity", inversedBy="method")
	...
	/**
	 * @var ArrayCollection
	 * @ORM\OneToMany(targetEntity="BioquantityVariables", mappedBy="bioquantityMethodVariable")
	 */
	protected $variables;
	...
	/**
	 * @return BioquantityVariables[]|Collection
	 */
